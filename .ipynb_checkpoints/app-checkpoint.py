...
def generate_slide_content(slide_name, custom_prompt=None):
    ...
    # Get the API key from environment or use fallback value
    API_KEY = os.getenv("OPENAI_API_KEY", "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")

    # Set the API key for OpenAI
    openai.api_key = "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"
